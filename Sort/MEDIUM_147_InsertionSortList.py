...
if __name__ == "__main__":
    ...
    tail = ListNode(reversed_values[0], None)
    _next = tail
    for val in reversed_values[1:-1]:
        _next = ListNode(val, _next)
    head = ListNode(reversed_values[-1], _next)
    ...
    assert sorted(values) == sorted_vals
